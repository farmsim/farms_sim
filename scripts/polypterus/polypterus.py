...
def main(animat='polypterus', version='v0'):
    """Main"""
    ...
    animat_options = get_polypterus_options(
    ...
    if clargs.test:
        # Save options
        animat_options_filename = 'polypterus_animat_options.yaml'
        animat_options.save(animat_options_filename)
        simulation_options_filename = 'polypterus_simulation_options.yaml'
