...
def get_salamander_kwargs_options(**kwargs):
    ...
    kwargs_options = {
        ...
        'weight_sens_stretch_freq_up': +3e0,
        'weight_sens_stretch_freq_same': -6e0,
        'weight_sens_stretch_freq_down': +3e0,
        'weight_sens_stretch_amp_down': -1e1,
        'weight_sens_contact_intralimb': -2e0,
        'weight_sens_contact_opposite': 0,
        'weight_sens_contact_following': 0,
        'weight_sens_contact_diagonal': 0,
        'weight_sens_hydro_freq_down': +5e2,
        'weight_sens_hydro_amp_up': 0,
...
def get_polypterus_kwargs_options(**kwargs):
    ...
    kwargs_options = {
        ...
        'weight_osc_legs2body': 1e1,
        'weight_osc_body2legs': 1e1,
        'weight_sens_stretch_freq_down': -1e1,
        'weight_sens_contact_intralimb': -2e0,
...
def get_centipede_kwargs_options(**kwargs):
    ...
    kwargs_options = {
        ...
        'weight_sens_stretch_freq_down': 1e1,
        'weight_sens_contact_intralimb': -2e0,
        'weight_sens_hydro_freq_down': -3e2,
        'body_walk_amplitude': 1,
        'body_osc_gain': 0.1,
        'body_osc_bias': 0,
        'legs_amplitudes': [
...
def get_krock_kwargs_options(**kwargs):
    ...
    kwargs_options = dict(
        ...
        weight_sens_contact_following=0,
        weight_sens_contact_diagonal=0,
        weight_sens_hydro_freq_down=0,
        weight_sens_hydro_amp_down=0,
        modular_phases=(
...
def get_amphibot_kwargs_options(**kwargs):
    ...
    kwargs_options = {
        ...
        'weight_osc_body_side': 3e1,
        'weight_osc_body_down': 3e1,
        'weight_sens_stretch_freq_same': 0,
        # 'weight_sens_stretch_freq_same': 1e2,
        'weight_sens_contact_intralimb': 0,
        'weight_sens_contact_opposite': 0,
        'weight_sens_contact_following': 0,
        'weight_sens_contact_diagonal': 0,
